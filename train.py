...
provided later on.
A trained model can be found in Model folder, named as, "Pre-Trained_DANNucNet". Use predict.py to use our
trained model.
----------------------------------------------------------------------------------------------------------------------
Usage
=====
...
Data_Folder = Main_Path + '/Data/PanNuke_Train_Data/'
...
with tf.device('/GPU:0'):
    lr_reducer = ReduceLROnPlateau(factor=0.5, patience=3, cooldown=0, min_lr=0.1e-5, verbose=1)
